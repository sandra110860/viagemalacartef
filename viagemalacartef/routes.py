...
from viagemalacartef import app, database, bcrypt
from viagemalacartef.models import Usuario, Foto
from flask_login import login_required, login_user, logout_user, current_user
from viagemalacartef.forms import FormLogin,FormCriarConta,  FormFoto
import os
...
@login_required
def feed():
    # limitar qtde de fotos que aparecem seria o :20
